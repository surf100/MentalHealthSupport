...
function getActionLabel(action: string): string {
  switch (action) {
    ...
    case "FORUM_POST_REVIEWED":                      return "Post Reviewed";
    case "FORUM_POST_DISMISSED":                     return "Post Dismissed";
    case "FORUM_POST_ESCALATED_TO_SPECIALIST":       return "Escalated";
    case "REPORT_REVIEWED":                          return "Report Reviewed";
    case "REPORT_DISMISSED":                         return "Report Dismissed";
    case "REPORT_ESCALATED_TO_SPECIALIST":           return "Report Escalated";
  ...
  return (
    <div className="grid grid-cols-12 gap-4 px-6 py-5 items-center border-b border-[#D6DCE1]/40 last:border-0">
      <div className="col-span-3">
        <div className="h-3.5 w-28 rounded animate-pulse" style={{ backgroundColor: "rgba(36,76,90,0.08)" }} />
      </div>
      <div className="col-span-3">
        <div className="h-6 w-24 rounded-full animate-pulse" style={{ backgroundColor: "rgba(136,187,214,0.18)" }} />
      </div>
      <div className="col-span-2">
        <div className="h-3.5 w-20 rounded animate-pulse" style={{ backgroundColor: "rgba(36,76,90,0.06)" }} />
      </div>
      <div className="col-span-2">
        <div className="h-3.5 w-24 rounded animate-pulse" style={{ backgroundColor: "rgba(36,76,90,0.06)" }} />
      </div>
      <div className="col-span-2">
        <div className="h-3.5 w-32 rounded animate-pulse" style={{ backgroundColor: "rgba(36,76,90,0.06)" }} />
      </div>
    </div>
  );
}
    ...
    >
      ...
      <div className="relative overflow-hidden border-b" style={{ backgroundColor: "#A3CEF1", borderColor: "rgba(36,76,90,0.12)" }}>
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-14 py-12">
          ...
          >
            Review every moderation and administrative action across the SafeSpace platform. All entries are immutable and timestamped.
          </p>
        </div>
      </div>
            ...
            <aside className="col-span-12 lg:col-span-3">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <p className="font-display text-[32px] leading-none mt-1 tracking-[-0.03em]" style={{ color: "#274C77" }}>
                      {loading ? <span className="inline-block h-8 w-12 rounded animate-pulse" style={{ backgroundColor: "rgba(36,76,90,0.08)" }} /> : logs.length}
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="font-display text-[32px] leading-none mt-1 tracking-[-0.03em]" style={{ color: "#274C77" }}>
                      {loading ? <span className="inline-block h-8 w-10 rounded animate-pulse" style={{ backgroundColor: "rgba(36,76,90,0.08)" }} /> : accountActions}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t" style={{ borderColor: "rgba(36,76,90,0.08)" }}>
                  <div className="space-y-3">
                    {[
                      { icon: Activity, label: "Action tracking", desc: "Moderation and admin activity" },
                      { icon: UserCog, label: "User management", desc: "Role changes & restrictions" },
                      { icon: ShieldCheck, label: "Moderation visibility", desc: "Transparent internal records" },
                      ...
                      {filteredLogs.map((log, idx) => {
                        ...
                        return (
                          <div
                            ...
                            style={{
                              borderBottom: idx < filteredLogs.length - 1 ? "1px solid rgba(36,76,90,0.07)" : "none",
                            }}
                          ...
                          >
                            ...
                            <div className="col-span-2">
                              <p
                                className="font-sans text-[13px] leading-snug tracking-[-0.01em]"
